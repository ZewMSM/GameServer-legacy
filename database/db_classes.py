...
class StructureDB(Base):
    ...
    upgrades_to = Column(Integer, nullable=False, default=0)

    # Requirements and Restrictions
    allowed_on_island = Column(String, nullable=False, default="")
    ...
    show_in_levelup = Column(Boolean, nullable=False, default=True)
    ...
    platforms = Column(String, nullable=False, default="")
